...
import { clearBuyBook, clearCart, removeBuyBook } from "@/store/index.actions";
...
import { Button, ConfigProvider, Form, message, Radio, Space, FormProps } from "antd";
								...
								>
									<span className="flex items-center gap-[30px]">
										<img
											...
											src={
												item?.image[0] ? item?.image[0]?.image_url : BkNoPhoto
											}
											alt="book image"
										/>
										<span>
